...
// TEST_CASE_FIXTURE(argument_test_fixture, "is_optional() should return true") {
...
// TEST_CASE_FIXTURE(argument_test_fixture, "is_required() should return true is argument is set to be required") {
//     auto sut = prepare_argument(long_name);
